...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Use Dominant Color for Play Screen'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Use Dominant and Darker Colors for Play Screen'**
  String get useDominantAndDarkerColors;

  /// No description provided for @useDominantAndDarkerColorsSub.
  ///
  /// In en, this message translates to:
  /// **'Dominant and Darker Color from Image will be used as the Gradient of the Player Screen Background. Only available if Use Dominant is ON (Better results if Use Dominant for Whole Screen is ON)'**
  String get useDominantAndDarkerColorsSub;

  /// No description provided for @useDominantFullScreen.
  ///
  /// In en, this message translates to:
  /// **'Use Dominant Color for the Whole Play Screen'**
  String get useDominantFullScreen;

  /// No description provided for @useDominantFullScreenSub.
  ///
  /// In en, this message translates to:
  /// **'Dominant Color from Image will be used for the Whole Play Screen Background. Only available if Use Dominant is ON'**
...
class _AppLocalizationsDelegate extends LocalizationsDelegate<AppLocalizations> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['ar', 'bn', 'cs', 'de', 'en', 'es', 'fr', 'gu', 'hi', 'id', 'it', 'ja', 'kn', 'ml', 'ne', 'nl', 'or', 'pl', 'pt', 'ru', 'ta', 'tr', 'vi', 'zh'].contains(locale.languageCode);
